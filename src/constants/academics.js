export const ACADEMICS_GENERAL = [
  ...
  { label: 'Complete Address with PIN Code', value: '—' },
...
export const ACADEMICS_DOCUMENTS = [
  ...
  'Copies of Land Certificate as Applicable',
  ...
  'Copies of Valid Water, Health, Sanitation Certificates',
]

export const ACADEMICS_ACADEMIC_DOCS = [
